...
class MargoBot:
    ...
    def main_loop(self):
        ...
        while self.running:
            if not self.find_element_and_click('images/autobutton.png', 0.5):
    ...
    def resolve_captcha(self):
        ...
        if self.cv_act.is_element_visible_after_seconds('images/arcymagnaszyjniki.png', self.default_screenshot_path,
            ...
            to_search = 'buty'
                                                          ...
                                                          0.2):
            to_search = 'pierscien'
        elif self.cv_act.is_element_visible_after_seconds('images/arcymaghelmy.png', self.default_screenshot_path, 0.2):
            to_search = 'helm'
    ...
    def check_if_low_hp_and_heal(self):
        ...
        while not (bgr[0] == 17 and bgr[1] == 17 and bgr[2] == 167):
