...
class MargoBot:
    def __init__(self):
        self.__driver = WebdriverWrapper()
        self.sel_act = SeleniumActions(self.__driver.driver)
        self.cv_act = OpencvActions(self.__driver.driver)
        self.timeout = 3
        self.running = True
    ...
    def get_to_loginpage_and_login(self):
        ...
        self.send_keys_and_confirm(self.__driver.userName)
        self.find_element_and_click('images/passfield.png', self.timeout)
        self.send_keys_and_confirm(self.__driver.password)
